...
async def login_with_credentials(
	...
	*,
	...
	"""使用浏览器登录，返回 cookies 与拦截到的 api user id。"""
	...
	try:
		...
		if auth_method == 'github':
			try:
				...
				pass
			try:
				await page.goto(f'{provider_config.domain}/logout', wait_until='domcontentloaded', timeout=15_000)
			except Exception as exc:  # nosec B110
				debug_print(f'[INFO] {account_name}: Logout warmup skipped: {exc}')
